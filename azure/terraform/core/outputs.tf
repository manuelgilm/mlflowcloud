...
output "primary_connection_string" {
  ...
  value       = azurerm_storage_account.artifact_storage.primary_connection_string
  sensitive   = true
}

output "primary_access_key" {
  description = "The primary access key for the Storage account."
  value       = azurerm_storage_account.artifact_storage.primary_access_key
  sensitive   = true
}

output "artifact_root" {
  description = "Default artifact root"
  value       = "wasbs://${azurerm_storage_container.artifact_container.name}@${azurerm_storage_account.artifact_storage.name}.blob.core.windows.net/mlflow-artifacts"
  sensitive   = false
}
